    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="/update_security/<?php echo $user_info['id']; ?>" method="post">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="email" type="email" id="simpleinput" class="form-control" value="<?php echo $user_info['email']; ?>">
                                </div>
