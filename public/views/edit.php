<?php $this->layout('layout'); ?>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="/update_user/<?php echo $user['id'];?>" method="post">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="address_job" type="text" id="simpleinput" class="form-control" value="<?php echo $user['address_job'];?>">
                                </div>
